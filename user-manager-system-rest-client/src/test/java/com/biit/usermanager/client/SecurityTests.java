...
public class SecurityTests extends AbstractTestNGSpringContextTests {
    ...
    public void setDefaultData() {
        ...
        admin = (UserDTO) userController.createUser(USER1_NAME, USER1_UNIQUE_ID, USER1_FIRST_NAME, USER1_LAST_NAME, USER1_PASSWORD, null);
        guest = (UserDTO) userController.createUser(USER2_NAME, USER2_UNIQUE_ID, USER2_FIRST_NAME, USER2_LAST_NAME, USER2_PASSWORD, null);
