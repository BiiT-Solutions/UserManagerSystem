...
public class ConfigurationInfo {
    ...
    @Autowired
    public ConfigurationInfo(Environment environment, ApplicationArguments applicationArguments) {
        this.environment = environment;
        this.applicationArguments = applicationArguments;
    }

    @Operation(summary = "Configuration info")
    @PostMapping(value = "/configuration", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.TEXT_PLAIN_VALUE)
    ...
    public Map<String, String> info(HttpServletRequest request, @RequestBody String hash)
        ...
        info.put("path", ConfigurationInfo.class.getProtectionDomain().getCodeSource().getLocation().getPath());
