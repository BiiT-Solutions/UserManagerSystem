...
@Controller
public class ApplicationBackendServiceRoleController extends CreatedElementController<ApplicationBackendServiceRole, ApplicationBackendServiceRoleId, ApplicationBackendServiceRoleDTO, ApplicationServiceRoleRepository,
        ApplicationBackendServiceRoleProvider, ApplicationServiceRoleConverterRequest, ApplicationBackendServiceRoleConverter> {
    ...
    @Autowired
    protected ApplicationBackendServiceRoleController(ApplicationBackendServiceRoleProvider provider, ApplicationBackendServiceRoleConverter converter, RoleProvider roleProvider,
    ...
    @Override
    protected ApplicationServiceRoleConverterRequest createConverterRequest(ApplicationBackendServiceRole entity) {
        return new ApplicationServiceRoleConverterRequest(entity);
    }
