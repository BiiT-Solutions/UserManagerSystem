 ...
 */
public class AuthenticationServiceLogger extends BasicLogger {

    private static final Logger logger = LoggerFactory.getLogger(AuthenticationServiceLogger.class);
