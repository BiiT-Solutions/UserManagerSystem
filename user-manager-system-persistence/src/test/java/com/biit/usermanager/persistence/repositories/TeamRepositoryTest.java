...
public class TeamRepositoryTest extends AbstractTestNGSpringContextTests {
    ...
    public void addTeamMembers() {
        teamMemberRepository.save(new TeamMember(team.getId(), user.getId(), team.getOrganization().getName(), null));
        teamMemberRepository.save(new TeamMember(team2.getId(), user2.getId(), team.getOrganization().getName(), null));
        teamMemberRepository.save(new TeamMember(team2.getId(), user3.getId(), team.getOrganization().getName(), null));
        teamMemberRepository.save(new TeamMember(team3.getId(), user3.getId(), team.getOrganization().getName(), null));
    }
