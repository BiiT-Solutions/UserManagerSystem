 ...
 */
public class UserManagerLogger extends com.biit.usermanager.logger.BasicLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserManagerLogger.class);
